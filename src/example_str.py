...
print(extractor.position_is_checkmate())
print(extractor.position_is_stalemate())
print(extractor.position_is_game_over())
print(extractor.position_legal_move_count())
